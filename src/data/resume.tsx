...
export const DATA = {
  ...
  description:
    "Support Engineer turned Software Engineer. I love building things and helping people.",
  summary:
    "I'm a Senior Technical Support Engineer at Salesforce transitioning to software engineering. With expertise in API integrations, Python, and web development, I solve complex problems for global clients. My journey spans from 3D mobile apps to frontend web development. Explore my projects to see how I'm applying these skills to create innovative software solutions!",
